...
public class TrafficUtil {
     ...
     * @param uid
     */
    public TrafficUtil(Context context, Handler handler, int uid) {
        this.context = context;
        this.handler = handler;
        this.UUID = uid;
    }

    public TrafficUtil(Context context, Handler handler) {
        this.context = context;
        this.handler = handler;
    }
     ...
     * @return
     */
    public static TrafficUtil getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new TrafficUtil(context, handler);
        }
        return instance;
    }
